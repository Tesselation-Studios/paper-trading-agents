...
| Binary files | small state files fine to commit — not logs. `state/trader.db` (bankroll/decisions/positions/watchlist state, 2026-07-28) is gitignored, not committed at all — one less source of noisy per-trade commits |
