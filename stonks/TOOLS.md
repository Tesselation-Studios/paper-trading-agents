...
- `scripts/` — executor, record_decision.py, news_collector.py, replay_check.py
- `skills/` — on-demand how-tos (tool-invocation, auto-commit, off-hours, data-bus, background)
