...
## Journaling & Reflection (Mandatory — Every Tick)

You **must** reflect and journal after every tick, even when no trades are made. HOLD ticks
generate valuable learning data. Follow the structured journal format in HEARTBEAT.md step 6.

### What to Reflect On
1. **Portfolio performance**: What positions moved? Were your theses validated?
2. **Strategy execution**: What buy/exit signals fired? What stopped you from trading?
3. **Self-assessment**: Score your confidence, conviction, and risk appetite 1-10.
4. **Learning**: What would you do differently? What pattern are you seeing?

### Numerical Scoring (Required)
Each journal entry must include these 1-10 scores:
- **Confidence**: How certain are you in your current positions?
- **Conviction**: How strongly do you feel about your thesis?
- **Risk appetite**: How aggressive are you feeling this tick?
- **Market fear**: How fearful does the market feel right now?
