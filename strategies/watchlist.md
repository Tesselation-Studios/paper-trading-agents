...
## Candidates
- VTEX — idle_ticks: 9 — from 2026-07-24.md ($3.88, RSI 46.5, MACDh +0.0826 🟢, vol 0.45x extremely thin, SaaS e-commerce platform. Earnings est. Aug 6. No entry — too thin.)
...
_Last touched: 2026-07-24 14:50 ET (bumped VTEX→9). Watchlist still 1 active candidate (vol <1.0x, no qualifying entries)._
