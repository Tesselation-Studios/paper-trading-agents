...
## Candidates
- OZKAP — idle_ticks: 22 — $16.35, RSI 54.4, vol 1.27x, MACD bullish +0.0098, dividend raise catalyst (sentiment +0.88). ⚠️ Attempted BUY 09:50 — failed to fill (preferred stock). Do not retry.
~~BFST~~ — entered 2026-07-24 10:05, 1 share @ $30.98, probe entry
- NKLR — idle_ticks: 22 — $5.42, RSI 56.5, vol 0.88x, MACD bearish -0.1261, news: NRC readiness review (sentiment +0.65)
...
_Last touched: 2026-07-24 11:30 ET (idle_ticks bumped OZKAP→22 NKLR→22, all HOLD)._
