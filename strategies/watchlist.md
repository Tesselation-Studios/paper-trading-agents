...
- TEVA — idle_ticks: 0 — probe discovery 07/20: generic pharma, opioid settlement behind, specialty pipeline growing ($31.36)
- AEO — idle_ticks: 0 — probe discovery 07/20: retail near lows, back-to-school catalyst, high SI squeeze potential ($17.43)
- RDDT — idle_ticks: 0 — probe discovery 07/20: post-IPO social, AI data licensing, limited comp ($184.52 — monitor, near cap)
- UBER — idle_ticks: 0 — probe discovery 07/20: duopoly, FCF-positive, AV optionality ($72.38)
- AFRM — idle_ticks: 0 — probe discovery 07/20: BNPL leader, rate-cut beneficiary, Amazon/Shopify/Walmart network ($76.99)
- UPST — idle_ticks: 0 — probe discovery 07/20: AI lending, beaten down, rate-cut re-fi catalyst ($29.09 — fits small-cap well)
- OXY — idle_ticks: 0 — probe discovery 07/20: Berkshire stake, carbon capture, energy sector gap ($55.50)
- TOST — idle_ticks: 0 — probe discovery 07/20: restaurant tech, growing merchant base ($24 area)
