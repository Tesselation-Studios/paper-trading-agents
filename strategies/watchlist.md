...
## Candidates
- FDIV — idle_ticks: 22 — $27.55, RSI 50.6, vol 4.56x (!), news: Emerson/Aramco corrosion monitoring collab (+0.95)
- COAG — idle_ticks: 22 — $49.73 mid, RSI 61.5, vol 0.95x, news: Hemab clinical data (neutral)
- MATE — idle_ticks: 22 — $29.95 mid, RSI 60.7, vol 0.85x, no news — technical only
- SRET — idle_ticks: 10 — $22.72, RSI 49.8, vol 1.07x, news: mortgage rates at lowest since Feb 2023 (sentiment -0.97)
