...
## Candidates
- RKT — idle_ticks: 14 — RSI(14)=38.6 (below band), from 2026-07-22.md
- CLF — idle_ticks: 14 — RSI(14)=45.6 (barely in band, skipped 14:55-15:50), from 2026-07-22.md
...
_Last touched: 2026-07-23 09:31 ET (OPEN closed trailing stop -5.11%, NVDA trimmed 3 shares oversized, RKT/CLF idle→14, new entries gated CHOPPY)._ 
